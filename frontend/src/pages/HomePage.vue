...
<template>
  <q-page class="q-pa-md q-w-auto">
    <div class="q-pt-xl">
      <q-card class="q-pa-md row" style="min-width: 300px">
        <q-avatar size="400px" color="primary" text-color="white" class="q-mb-md">
          <!-- {{ name.charAt(0).toUpperCase() }} -->
          <q-icon name="person"></q-icon>
        </q-avatar>
        <q-card-section class="text-align:left">
